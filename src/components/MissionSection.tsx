        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center mt-20 mx-0 px-0 py-[50px] my-[125px]">
              <div className="grid grid-cols-3 gap-16 w-full max-w-6xl mx-0 my-0 px-[32px] py-0">
                ...
                <div className="text-center -mt-2">
                  <p style={{
                  color: '#f4a756'
                }} className="text-2xl font-bold text-[#f4a756] mx-0 my-0 py-[45px]">
                    {t('mission.card2')}
                  </p>
                </div>
                <div className="text-center -mr-6 -mt-6">
                  <p style={{
                  color: '#f4a756'
                }} className="text-2xl font-bold whitespace-pre-line text-[#f4a756] py-[60px]">
                    {t('mission.card3')}
                  </p>
                </div>
              </div>
